...
class ApiController extends Controller
{
    public function register(Request $request): JsonResponse
    {
        ...
        return response()->json([
            ...
            'data' => $user
        ], Response::HTTP_CREATED)->setEncodingOptions(JSON_UNESCAPED_SLASHES | JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE);
    }
    ...
    public function login(Request $request): JsonResponse
    {
        ...
        try {
            ...
            ], 500)->setEncodingOptions(JSON_UNESCAPED_SLASHES | JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE);
        }
    ...
    public function logout(Request $request): JsonResponse
    {
        ...
        try {
            ...
            ], Response::HTTP_INTERNAL_SERVER_ERROR)->setEncodingOptions(JSON_UNESCAPED_SLASHES | JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE);
        }
    }
